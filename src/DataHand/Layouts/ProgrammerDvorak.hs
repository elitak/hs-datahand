...
--      +----+           +----+           +----+           +----+
          lab              lb               lcb              lp
-- +----+----+----+ +----+----+----+ +----+----+----+ +----+----+----+ +----+----+----+
     ø    svn Plus    ø   Five  ø      lab  thr  rab    til  One Nine    ø    ø    ø
-- +----+----+----+ +----+----+----+ +----+----+----+ +----+----+----+ +----+----+----+
         bktk             perc              ø                eq         Norm  ø    ø
--      +----+           +----+           +----+           +----+      +----+----+----+
...
--      +----+           +----+           +----+           +----+
          ø                ø               pgup              up
-- +----+----+----+ +----+----+----+ +----+----+----+ +----+----+----+ +----+----+----+
     F11  ø    F9     F7   ø    F5     F3  End   F1   left Home rite     ø   caps  ø
-- +----+----+----+ +----+----+----+ +----+----+----+ +----+----+----+ +----+----+----+
          ø                ø               pgdn             down        Norm  ø    ø
--      +----+           +----+           +----+           +----+      +----+----+----+
